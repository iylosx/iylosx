$(document).ready(function(){
    ...
    const archive_swiper = new Swiper('.archive .swiper', { /* 팝업을 감싼는 요소의 class명 */
        slidesPerView: 'auto', /* 한번에 보일 팝업의 수 - 모바일 제일 작은 사이즈일때 */
        spaceBetween: 15, /* 팝업과 팝업 사이 여백 */
        breakpoints: {
            640: {    /* 640px 이상일때 적용 */
        ...
        navigation: {
            nextEl: '.archive .ctrl_btn .btn_next',
            prevEl: '.archive .ctrl_btn .btn_prev',
        },
